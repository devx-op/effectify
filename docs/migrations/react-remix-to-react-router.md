...
| login                 | `/login` UI flow                                           | existing-rr8              | `apps/react-router-example/app/routes/login.tsx`; focused interaction/error evidence is required before completion.                                                | kattsushi | NO       |
| signup                | `/signup` UI flow                                          | existing-rr8              | `apps/react-router-example/app/routes/signup.tsx`; focused interaction/error evidence is required before completion.                                               | kattsushi | NO       |
| auth-api              | `/api/auth/*` request, body, status, redirect, and cookies | existing-rr8              | `apps/react-router-example/app/routes/api.auth.ts` and RR8 adapter tests; add combined redirect/multiple-cookie fidelity evidence.                                 | kattsushi | NO       |
...
| test-action-success   | `/test` action success payload                             | existing-rr8              | Accepted `/demo` transfer will provide the focused user-visible action-success evidence; keep incomplete until that test passes.                                   | kattsushi | NO       |
| demo-loader-success   | `/demo` loader success helper                              | transfer-to-rr8           | Unique six-way helper demonstration is absent from RR8; transfer as one coherent `/demo` route/test slice.                                                         | kattsushi | NO       |
| demo-loader-failure   | `/demo` loader failure helper                              | transfer-to-rr8           | Unique six-way helper demonstration is absent from RR8; transfer as one coherent `/demo` route/test slice.                                                         | kattsushi | NO       |
| demo-loader-redirect  | `/demo` loader redirect helper                             | transfer-to-rr8           | Unique six-way helper demonstration is absent from RR8; transfer as one coherent `/demo` route/test slice.                                                         | kattsushi | NO       |
| demo-action-success   | `/demo` action success helper                              | transfer-to-rr8           | Unique six-way helper demonstration is absent from RR8; transfer as one coherent `/demo` route/test slice.                                                         | kattsushi | NO       |
| demo-action-failure   | `/demo` action failure helper                              | transfer-to-rr8           | Unique six-way helper demonstration is absent from RR8; transfer as one coherent `/demo` route/test slice.                                                         | kattsushi | NO       |
| demo-action-redirect  | `/demo` action redirect helper                             | transfer-to-rr8           | Unique six-way helper demonstration is absent from RR8; transfer as one coherent `/demo` route/test slice.                                                         | kattsushi | NO       |
