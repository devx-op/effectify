    ...
    <article>
      ...
      <Form method="post">
        <fieldset>
          ...
          <input id="title" name="title" type="text" placeholder="Enter todo title..." />

          <label htmlFor="content">Content</label>
          <textarea id="content" name="content" placeholder="Enter description... (optional)" rows={3} />
        </fieldset>
            ...
            <li key={todo.id}>
              ...
              >
                ...
                <input
                  ...
                  onChange={() => submit({ intent: "toggle", id: todo.id }, { method: "post" })}
                />
              ...
              {editingId === todo.id && (
                ...
                >
                  ...
                  <div style={{ display: "grid", gap: "0.5rem" }}>
                    <label>
                      Title
                      <input name="title" type="text" defaultValue={todo.title} placeholder="Todo title" required />
                    </label>
