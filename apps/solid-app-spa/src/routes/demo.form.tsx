...
function FieldWrapper(props: {
  ...
  return (
    <div>
      ...
      {props.children}
      {props.errors.length ? <div class="text-red-500 mt-1 font-bold">{props.errors.join(', ')}</div> : null}
    </div>
  )
}
...
function FormExample() {
  ...
  return (
    <div
      ...
      style={{
        'background-image': 'radial-gradient(50% 50% at 5% 40%, #f4a460 0%, #8b4513 70%, #1a0f0a 100%)',
      }}
    >
        ...
        >
          ...
          <div>
            <form.Field
              ...
              children={(field) => (
                <FieldWrapper label="Full Name" errors={field().state.meta.errors}>
                  <input
                    id="fullName"
                    name="fullName"
          ...
          <div>
            <form.Field
              ...
              children={(field) => (
                <FieldWrapper label="Email Address" errors={field().state.meta.errors}>
                  <input
                    id="email"
                    name="email"
                    type="email"
          ...
          <div>
            <form.Field
              ...
              children={(field) => (
                <FieldWrapper label="Street Address" errors={field().state.meta.errors}>
                  <input
                    id="street"
                    name="street"
                    value={field().state.value}
          ...
          <div>
            <form.Field
              ...
              children={(field) => (
                <FieldWrapper label="Phone Number" errors={field().state.meta.errors}>
                  <input
                    id="phone"
                    name="phone"
                    type="tel"
