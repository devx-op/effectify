...
Deterministic Nx/pnpm tests MUST cover every crash boundary, validation class, replay law, path/permission defense, recovery outcome, and cleanup guard without failed-recovery mutation.
