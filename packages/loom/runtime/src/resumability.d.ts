...
export declare const makeExecutableRef: (modulePath: string, exportName: string) => ExecutableRef
export declare const isStableExecutableRef: (value: unknown) => value is string
export declare const createContract: (draft: ContractDraft) => Promise<LoomResumabilityContract>
export declare const encodeContract: (contract: LoomResumabilityContract) => string
...
export declare const handler: <Handler>(ref: ExecutableRef, value: Handler) => ReferencedHandler<Handler>
export declare const liveRegion: <Value>(
  ref: ExecutableRef,
  render: (value: Value) => LoomCore.Ast.Node,
) => ReferencedLiveRegion<Value>
export declare const makeLocalRegistry: () => LocalRegistry
...
export declare const resolveHandler: (registry: LocalRegistry, ref: ExecutableRef) => HandlerExecutable
export declare const resolveLiveRegion: (registry: LocalRegistry, ref: ExecutableRef) => LiveRegionExecutable
