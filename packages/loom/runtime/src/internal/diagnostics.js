...
const makeBoundarySubject = (boundaryId) => `boundary:${boundaryId}`
const makeActivationSubject = (issue) => {
  const parts = [
...
const makeHydrationMismatchMessage = (mismatch) => {
...
const makeHydrationActivationMessage = (issue) => {
  switch (issue.reason) {
...
const makeHydrationActivationSeverity = (issue) => {
  switch (issue.reason) {
    case "unsupported-live-content":
      return "warn"
    default:
...
const makeResumabilityMessage = (issue) => {
  switch (issue.reason) {
...
export const fromHydrationMismatches = (mismatches) => {
...
export const fromHydrationActivation = (result) => {
  const issues = [
...
export const fromRenderResumability = (result) => {
