...
export declare function use<Props, Err, Requirements, Model extends ModelShape, Actions extends ActionShape>(
...
export declare function use<
  ...
  Actions extends ActionShape,
  Slots extends SlotShape,
>(component: Type<Props, Err, Requirements, Model, Actions, Slots, false>, slots: SlotInput<Slots>): View.Node
export declare function use<
  Props,
  Err,
  Requirements,
