...
export interface SSRResult {
   ...
   */
  dehydratedState: Hydration.DehydratedAtom[]
 ...
 * @category SSR
 */
export const renderAtomsStatic = (registry: Registry.Registry, atoms: Atom.Atom<any>[]): Record<string, any> => {
 ...
 * @category SSR
 */
export const extractCriticalAtoms = (registry: Registry.Registry, criticalKeys: string[]): Atom.Atom<any>[] => {
  const nodes = registry.getNodes()
  const criticalAtoms: Atom.Atom<any>[] = []
