...
describe('SSR Utilities', () => {
  ...
  describe('preloadAtoms', () => {
    test('should preload simple atoms', async () => {
      ...
      const result = await Effect.runPromise(preloadAtoms(registry, [atom1, atom2]))
    ...
    test('should handle async atoms', async () => {
      ...
      const result = await Effect.runPromise(preloadAtoms(registry, [asyncAtom], { timeout: 1000 }))
