...
export interface Task<out Name extends string, out Input, out Output, out Error, out Requirements> {
  ...
  execute(input: Input, context: Context): Effect.Effect<Output, Error, Requirements>
}

export interface DurableTask<out Name extends string, out Input, out Output, out Error, out Requirements> {
  ...
  readonly inputSchema: Schema.Codec<Input, unknown, never, never> | undefined
  readonly outputSchema: Schema.Codec<Output, unknown, never, never> | undefined
  execute(input: Input, context: DurableContext): Effect.Effect<Output, Error, Requirements>
}
...
export type Any<Requirements = unknown> = Of<string, unknown, unknown, unknown, Requirements>
...
export interface MakeOptions<Name extends string, Input, Output, Error, Requirements> {
  ...
  readonly rateLimits?: ReadonlyArray<RateLimit.RateLimit>
  readonly triggers?: ReadonlyArray<Trigger.Trigger>
  readonly fn: (input: Input, context: Context) => Effect.Effect<Output, Error, Requirements>
}

export interface DurableOptions<Name extends string, Input, Output, Error, Requirements> {
  readonly name: Name
  readonly input?: Schema.Codec<Input, unknown, never, never>
  readonly output?: Schema.Codec<Output, unknown, never, never>
  readonly rateLimits?: ReadonlyArray<RateLimit.RateLimit>
  readonly triggers?: ReadonlyArray<Trigger.Trigger>
  readonly fn: (input: Input, context: DurableContext) => Effect.Effect<Output, Error, Requirements>
}
...
export const durable = <const Name extends string, Input, Output, Error, Requirements>(
